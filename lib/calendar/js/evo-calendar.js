            ...
            _.initials = {
                ...
                dates: {
                    ...
                    pt: {
                        ...
                        noEventForToday: "Nenhum agendamento para hoje.",
                        noEventForThisDay: "Nenhum agendamento para esse dia.",
    ...
    EvoCalendar.prototype.buildTheBones = function() {
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            markup += '<div class="calendar-events">'+
                            ...
                            '<button onclick="openModal()" id="modalBtn"><i class="bi bi-plus-circle-fill"></i></button>'+
                        '</div>';
