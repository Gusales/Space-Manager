...
VALUES (
        1,
        'Administrador',
        'spacemanagergr@gmail.com',
        '$2b$10$tH3FpJSfFtHCfX9Rg7ozYebGSXg5wDBavTx4JN4CELuuFBY0xlVma',
        '0',
        '(00)00000-0000',
        1,
        'admin',
    ...
    (
        2,
        'Professor 01',
        'gussales14@gmail.com',
        '$2b$10$sU5aNsyE7diHoiOsOkha7uZVV7.Dt1WhTeJqGw7af5DCOS4z4ElOa',
        '00001',
        '(00)00000-0000',
        1,
        'prof',
    ...
    (
        3,
        'Coordenador 01',
        'gustavosalles2005@outlook.com',
        '$2b$10$apGVkGHlXrEeKbN4XrV8s.4b0H5CUylCpECvhYFgya6Q3DLMnBFUm',
        '00002',
        '(00)00000-0000',
        1,
        'coord',
    ...
    (
        4,
        'Professor 02',
        'gustavo.souza418@etec.sp.gov.br',
        '$2b$10$6LS6rVF69kzMv1XZfKUVA.GZBh0D04vc9EqnN0e4cSViJdZlo5tRK',
        '00003',
        '(00)00000-0000',
        0,
        'prof',
...
VALUES (
        1,
        '1 ano de Informática para Internet',
        '2022-12-05 19:55:11',
        '2022-12-05 19:55:11'
    ),
    (
        2,
        '2 ano de Informática para Internet',
        '2022-12-05 19:55:20',
        '2022-12-05 19:55:20'
    ),
    (
        3,
        '3 ano de Informática para Internet',
        '2022-12-05 19:55:27',
        '2022-12-05 19:55:27'
    ),
    (
        4,
        '1 ano de Contabilidade',
        '2022-12-05 19:55:38',
        '2022-12-05 19:55:38'
    ),
    (
        5,
        '2 ano de Contabilidade',
        '2022-12-05 19:55:43',
        '2022-12-05 19:55:43'
    ),
    (
        6,
        '3 ano de Contabilidade',
        '2022-12-05 19:55:48',
        '2022-12-05 19:55:48'
    ),
    (
        7,
        '1 ano de Administração',
        '2022-12-05 19:55:57',
        '2022-12-05 19:55:57'
    ),
    (
        8,
        '2 ano de Administração',
        '2022-12-05 19:56:06',
        '2022-12-05 19:56:06'
    ),
    (
        9,
        '3 ano de Administração',
        '2022-12-05 19:56:38',
        '2022-12-05 19:56:38'
    );
...
VALUES (
    ...
    (
        ...
        '12:50',
        'Auditório',
        'Apresentação dos Trabalhos de Conclusão de Curso da turma de 3 administração',
        'yellow',
        '20:51:7',
        '2022-12-05 23:51:07',
        '2022-12-05 23:51:07'
...
--
ALTER TABLE `smcads` ADD PRIMARY KEY (`idCad`);

--
-- Índices para tabela `smcurs`
--
ALTER TABLE `smcurs` ADD PRIMARY KEY (`idCurs`);

--
-- Índices para tabela `smespas`
--
ALTER TABLE `smespas` ADD PRIMARY KEY (`idEspa`);

--
-- Índices para tabela `smhoras`
--
ALTER TABLE `smhoras` ADD PRIMARY KEY (`idHora`);

--
-- Índices para tabela `smmats`
--
ALTER TABLE `smmats` ADD PRIMARY KEY (`idMat`);

--
-- Índices para tabela `smrelacionamentoreservas`
--
ALTER TABLE `smrelacionamentoreservas` ADD PRIMARY KEY (`idRel`);

--
-- Índices para tabela `smrelacionamentousermats`
--
ALTER TABLE `smrelacionamentousermats` ADD PRIMARY KEY (`idRel`);

--
-- Índices para tabela `smres`
--
ALTER TABLE `smres` ADD PRIMARY KEY (`idRes`);
...
--
ALTER TABLE `smcads`
MODIFY `idCad` int(4) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 5;
