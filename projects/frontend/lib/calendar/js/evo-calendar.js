...
(function (factory) {
      ...
      _.initials = {
        ...
        dates: {
          ...
          pt: {
            ...
            noEventForToday: "Você não possuí nenhum agendamento para hoje.",
            noEventForThisDay: "Você não possuí nenhum agendamento para esse dia, verifique as Reservas.",
  ...
  EvoCalendar.prototype.addEventList = function (event_data) {
    ...
    markup =
      ...
      '">';
    markup +=
      `<div class="event-info"><p class="event-title" id="${_.limitTitle(event_data.id)}">` +
  ...
  EvoCalendar.prototype.selectMonth = function (event) {
    ...
    if (typeof event === "string" || typeof event === "number") {
      ...
      if(_.$active.month < _.$current.month){
